...
namespace ketqua.Digits
{
    class Variables
    {
        ...
        public static string CURRENT_OPEN_DIRECTORY = System.IO.Directory.GetCurrentDirectory() + @"\";
        ...
        // Message
        public const string MSG_DATA_IMPORTED = "Dữ liệu %s đã được thêm vào";
        public const string MSG_DATA_EXISTED = "Dữ liệu $s đã tồn tại";
        ...
        public static ConnectDatabase cn = new ConnectDatabase();
        // number
