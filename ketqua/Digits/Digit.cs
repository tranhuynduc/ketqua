...
namespace ketqua.Digits
{
    public abstract class Digit
    {
        ...
        public void CalculateSingle()
        {
            ...
            string[] lines = Variables.cn.GetData(ConnectDatabase.IDataType.AllTwoDigit);
        ...
        public void calculateTable()
        {
            ...
            string[] baseLines = Variables.cn.GetData(ConnectDatabase.IDataType.AllTwoDigit);
            int lineLength = baseLines.Length;
            string[] lines = new String[limitDataLine];
            if (limitDataLine != 0 && lineLength > limitDataLine)
            {
                lines = Utils.SubArray(baseLines, lineLength - limitDataLine, limitDataLine);
        ...
        public void GetResultOfDay()
        {
            Console.WriteLine("===== Calculate Single ======= ");
            Variables.START_TIME = Utils.GetTime();
            string[] lines = Variables.cn.GetData(ConnectDatabase.IDataType.AllTwoDigit, 1);
        ...
        public void GenerateMessage()
        {
            ...
            string message = "";
            string baseMesssage = message += "Lo Xien " + (int)digitType;
            string endMessage = "x4.";
            int count = -1;
